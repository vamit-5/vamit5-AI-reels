...
FOLDERS = [
    {"key": "mute_text", "folder_id": os.environ.get("GDRIVE_FOLDER_MUTE_TEXT", ""), "mode": MODE_MUTE_MUSIC_TEXT},
    {"key": "keep_text", "folder_id": os.environ.get("GDRIVE_FOLDER_KEEP_TEXT", ""), "mode": MODE_KEEP_TEXT},
    {"key": "mute_notext", "folder_id": os.environ.get("GDRIVE_FOLDER_MUTE_NOTEXT", ""), "mode": MODE_MUTE_MUSIC_NOTEXT},
]
